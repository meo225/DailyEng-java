...
import com.dailyeng.repository.PlacementTestQuestionSetRepository;
...
public class PlacementTestService {
     ...
     */
    public Map<String, Object> getActiveQuestionSet() {
        PlacementTestQuestionSet qs = questionSetRepository.findByActiveTrue()
     ...
     */
    public PlacementTestResultResponse submitResult(String userId, SubmitPlacementTestRequest request) {
     ...
     */
    public PlacementTestResultsResponse getResults(String userId) {
        var results = resultRepository.findByUserIdOrderByCreatedAtDesc(userId);
    ...
    static Level mapLevel(String cefrLevel) {
        if (cefrLevel == null) return Level.A1;
        try {
