...
public class DoraraLearnerDataService {
     ...
     */
    public String buildLearnerContext(String userId) {
    ...
    private void appendStudyGoal(StringBuilder sb, String userId) {
        studyPlanRepository.findByUserId(userId).ifPresent(plan -> {
