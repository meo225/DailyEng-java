...
public class TravelDataSeeder implements CommandLineRunner {
    ...
    private void seedHotels(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Give your name", "Show your ID", "Get your room key", "Ask where your room is"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Call the front desk", "Explain what you need", "Confirm the request", "Say thank you"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Specify dates and room type", "Ask about amenities", "Understand pricing and policies", "Confirm the reservation"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Describe problems clearly", "Express expectations reasonably", "Negotiate compensation", "Maintain professional tone"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Specify detailed event requirements", "Negotiate pricing and packages", "Coordinate multiple service elements", "Establish contingency plans"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Articulate partnership vision", "Navigate brand alignment concerns", "Structure complex value exchange", "Build long-term relationship foundation"));
    ...
    private void seedAirports(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Ask where your gate is", "Understand the directions", "Ask how long it takes to walk", "Say thank you"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Present your documents", "Choose your seat if possible", "Check your luggage", "Get your boarding pass"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Follow security procedures", "Answer officer questions", "Declare items if necessary", "Collect your belongings"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Understand cancellation reason", "Explore alternative options", "Negotiate for better arrangements", "Document everything for claims"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Coordinate multi-airport logistics", "Negotiate premium services", "Handle security protocols", "Manage contingencies across time zones"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Communicate with appropriate sensitivity", "Coordinate multi-stakeholder messaging", "Balance transparency with legal constraints", "Support affected parties compassionately"));
    ...
    private void seedTouristSites(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Ask for a ticket", "Ask the price", "Pay for the ticket", "Ask about opening hours"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Ask about tour times", "Ask about tour length", "Ask what you\'ll see", "Join the tour"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Explain your interests", "Ask about top attractions", "Get transportation advice", "Request a map or brochure"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Explain your photography project", "Negotiate access terms", "Understand restrictions", "Agree on usage rights"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Analyze conservation challenges", "Propose sustainable tourism approaches", "Balance stakeholder interests", "Consider long-term preservation"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Navigate politically sensitive terrain", "Build bridges through cultural exchange", "Balance national interests with cooperation", "Create sustainable people-to-people connections"));
    ...
    private void seedEmergency(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Say you lost your bag", "Describe your bag", "Say where you were", "Ask what to do"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Explain your symptoms", "Ask for a pharmacy or hospital", "Understand the directions", "Follow advice"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Report the loss to police", "Contact your embassy", "Gather required documents", "Understand the timeline"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Document the incident thoroughly", "Understand coverage details", "Provide required evidence", "Follow up appropriately"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Assess traveler locations and status", "Coordinate with local emergency services", "Manage communication across stakeholders", "Execute evacuation logistics"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Coordinate multi-government response", "Manage media sensitively", "Support affected families appropriately", "Balance transparency with operational security"));
