...
public class SocialSituationsDataSeeder implements CommandLineRunner {
    ...
    private void seedParties(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Ask about their job or studies", "Share about yourself", "Find common interests", "Keep the conversation going"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Welcome guests warmly", "Introduce people who don\'t know each other", "Keep conversations flowing", "Handle any awkward moments"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Start conversations naturally", "Exchange professional information", "Identify mutual opportunities", "Follow up appropriately"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Make appropriate impressions on VIPs", "Navigate status dynamics gracefully", "Build strategic relationships naturally", "Exit conversations diplomatically"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Observe appropriate diplomatic protocols", "Navigate cultural differences gracefully", "Build bridges while representing interests", "Handle sensitive topics with discretion"));
    ...
    private void seedSmallTalk(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Comment on the weather", "Listen to their response", "Add another comment", "End the conversation politely"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Ask about their day", "Share about your weekend or plans", "Find something to talk about", "Return to work naturally"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Introduce yourself as new", "Ask about the neighborhood", "Share a bit about yourself", "Express interest in being good neighbors"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Engage in appropriate openers", "Transition naturally to professional topics", "Find points of connection", "Exchange contact information naturally"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Recognize cultural differences in conversation norms", "Adapt communication style appropriately", "Build bridges across cultural divides", "Avoid cultural missteps"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Engage with ideas across domains", "Reference broad cultural knowledge appropriately", "Challenge ideas constructively", "Express nuanced perspectives elegantly"));
    ...
    private void seedMakingFriends(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Say hello", "Ask a simple question", "Share something about yourself", "Suggest doing something together"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Start a conversation about the class", "Find out about their interests", "Share about yourself", "Suggest meeting outside class"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Bond over shared interests", "Learn about their experience", "Share your own journey", "Propose meeting up"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Connect over shared expat experiences", "Share adjustment challenges and tips", "Find common interests beyond nationality", "Plan to stay in touch"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Acknowledge shared history", "Discover who they\'ve become", "Share your own evolution", "Establish new connection terms"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Share accumulated life wisdom", "Explore compatible values and perspectives", "Discuss what friendship means at this stage", "Establish authentic connection"));
    ...
    private void seedDating(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Say hello nicely", "Introduce yourself", "Ask a simple question", "Get their name"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Ask about their interests", "Share about yourself", "Find things in common", "Suggest meeting again"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Keep conversation flowing naturally", "Share interesting things about yourself", "Show genuine interest in them", "End on a positive note"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Discuss values and priorities", "Share relationship expectations", "Explore life goals", "Navigate any differences"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Express your feelings and needs clearly", "Listen to partner\'s perspective", "Find common ground on future", "Address concerns constructively"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Acknowledge complexity with nuance", "Discuss challenging topics with emotional intelligence", "Find creative solutions to challenges", "Deepen connection through difficulty"));
