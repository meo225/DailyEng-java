...
public class DailyLifeDataSeeder implements CommandLineRunner {
        ...
        private void seedShopping(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Ask where items are located", "Compare prices", "Ask about quantities",
                                                "Complete checkout"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Describe what you\'re looking for", "Ask about sizes and colors",
                                                "Request to try items", "Negotiate or ask about discounts"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Explain your technical requirements", "Compare different models",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Inquire about the item\'s history and provenance",
                                                "Diplomatically question authenticity", "Employ negotiation strategies",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Engage in sophisticated small talk", "Express nuanced preferences",
        ...
        private void seedDining(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Look at the menu", "Order food and drink", "Answer questions about your order",
                                                "Pay for your meal"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Greet the barista", "Order a drink with size preference",
                                                "Ask about available pastries", "Complete payment"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("State the date and time preference", "Specify number of guests",
                                                "Mention special occasion", "Confirm reservation details"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Discuss menu options with the server", "Ask about wine pairings",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Inquire about cooking techniques", "Discuss flavor profiles articulately",
                                                "Ask about ingredient sourcing", "Provide constructive feedback"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Present unique value proposition", "Address market positioning",
        ...
        private void seedHealthcare(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Explain you have a headache", "Ask for medicine", "Ask how to take it",
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Explain why you need to see a doctor", "Ask about available times",
                                                "Provide your information", "Confirm the appointment"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Describe your symptoms accurately", "Answer health history questions",
                                                "Understand the diagnosis", "Ask about medication"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Provide detailed medical history", "Discuss previous treatments",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Clarify coverage details", "Discuss pre-authorization requirements",
                                                "Understand out-of-pocket costs", "Negotiate coverage terms"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Articulate ethical principles clearly", "Balance competing interests",
                                                "Reference relevant precedents", "Propose actionable recommendations"));
        ...
        private void seedTransportation(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Greet the driver", "Say where you want to go", "Ask how long it takes",
                                                "Pay the fare"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Ask for tickets to your destination", "Specify date and time",
                                                "Ask about return tickets", "Complete the purchase"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Ask for directions to your gate", "Understand flight announcements",
                                                "Handle check-in procedures", "Deal with potential delays"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Specify vehicle requirements", "Understand insurance options",
                                                "Discuss mileage and fuel policies", "Complete rental agreement"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Assert passenger rights diplomatically", "Negotiate alternative arrangements",
                                                "Document issues for claims", "Coordinate multiple travel elements"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Analyze multi-stakeholder impacts", "Propose evidence-based solutions",
                                                "Address counterarguments", "Build consensus through dialogue"));
