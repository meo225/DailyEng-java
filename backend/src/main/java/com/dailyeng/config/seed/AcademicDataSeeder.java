...
public class AcademicDataSeeder implements CommandLineRunner {
    ...
    private void seedLectures(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Get the teacher\'s attention", "Ask your question", "Understand the answer", "Say thank you"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Ask about unclear concepts", "Request examples", "Take notes on explanations", "Confirm understanding"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Explain what\'s confusing you", "Ask specific questions", "Request additional resources", "Plan your study approach"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Present your interpretation of readings", "Engage with others\' viewpoints", "Raise thoughtful questions", "Connect concepts across texts"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Frame a research-level question", "Connect to your own work", "Engage with methodological choices", "Follow up on their response"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Articulate a nuanced position", "Engage critically with opposing arguments", "Use evidence effectively", "Maintain scholarly discourse norms"));
    ...
    private void seedDiscussions(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Share your ideas", "Listen to others\' ideas", "Ask questions", "Help make a decision"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Explain concepts you understand", "Ask about confusing topics", "Practice explaining ideas", "Help test each other"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Present your reading analysis", "Compare interpretations", "Build on others\' contributions", "Ask probing questions"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Present work clearly and concisely", "Receive feedback constructively", "Defend methodological choices", "Incorporate suggestions appropriately"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Bridge disciplinary languages", "Identify common ground", "Surface productive tensions", "Synthesize insights across perspectives"));
    ...
    private void seedResearch(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Ask where to find books", "Say what topic you need", "Understand the directions", "Thank the librarian"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Explain your research topic", "Ask about databases", "Learn how to search", "Get recommendations"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Present your research question", "Explain your methodology", "Discuss potential challenges", "Incorporate advisor\'s feedback"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Describe data collection issues", "Analyze possible causes", "Propose solutions", "Discuss implications for research"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Articulate research contribution clearly", "Defend methodological choices", "Address limitations honestly", "Respond to challenging questions"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Demonstrate ethical awareness", "Address committee concerns thoroughly", "Propose robust safeguards", "Balance research value with ethical protection"));
    ...
    private void seedPresentations(String groupId, String category) {
        ...
        save(groupId, category, sub, Level.A1,
                ...
                List.of("Show your item", "Describe it simply", "Answer one question", "Thank the class"));
        ...
        save(groupId, category, sub, Level.A2,
                ...
                List.of("Introduce your topic", "Share main information", "Use visual aids", "Answer simple questions"));
        ...
        save(groupId, category, sub, Level.B1,
                ...
                List.of("Explain your contribution clearly", "Connect to overall project", "Use evidence effectively", "Handle audience questions"));
        ...
        save(groupId, category, sub, Level.B2,
                ...
                List.of("Synthesize multiple sources", "Identify themes and gaps", "Provide critical analysis", "Connect to research questions"));
        ...
        save(groupId, category, sub, Level.C1,
                ...
                List.of("Communicate complex ideas accessibly", "Demonstrate scholarly rigor", "Handle expert questioning", "Position contribution to field"));
        ...
        save(groupId, category, sub, Level.C2,
                ...
                List.of("Present research program compellingly", "Demonstrate pedagogical vision", "Articulate future research directions", "Navigate committee dynamics"));
