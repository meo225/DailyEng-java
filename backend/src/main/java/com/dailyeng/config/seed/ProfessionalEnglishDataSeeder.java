...
public class ProfessionalEnglishDataSeeder implements CommandLineRunner {
        ...
        private void seedMeetings(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Say your name", "Say your job", "Say nice to meet everyone",
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Share your weekly progress", "Ask questions about tasks",
                                                "Understand deadlines", "Offer to help teammates"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Summarize completed work", "Explain current challenges", "Propose solutions",
                                                "Outline next steps"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Present your department\'s perspective", "Understand others\' constraints",
                                                "Find common ground", "Agree on action items"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Analyze market trends", "Evaluate strategic options",
                                                "Challenge assumptions constructively", "Build on others\' ideas"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Present compelling business case", "Demonstrate thorough risk analysis",
        ...
        private void seedPresentations(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Say your name and where you\'re from", "Talk about your job or studies",
                                                "Share one hobby", "Thank the audience"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Introduce the product clearly", "Explain main features", "Describe benefits",
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Explain the project concept", "Present the benefits", "Outline the timeline",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Present key metrics clearly", "Explain variances and trends",
                                                "Provide context for results", "Recommend next steps"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Present complex concepts accessibly", "Demonstrate methodological rigor",
                                                "Handle expert Q&A with confidence", "Engage audience effectively"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Craft compelling narrative arc", "Balance inspiration with substance",
                                                "Challenge audience assumptions", "Create memorable takeaways"));
        ...
        private void seedNegotiations(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Ask if the price is fixed", "Request a discount",
                                                "Accept or decline the offer", "Complete the deal"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("State your expected salary", "Explain your reasoning", "Ask about benefits",
                                                "Show flexibility"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Present your requirements", "Discuss pricing", "Negotiate delivery terms",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Understand their new constraints", "Present your position clearly",
                                                "Find creative solutions", "Formalize new agreement"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Explore mutual interests", "Structure value sharing equitably",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Justify valuation position", "Address integration concerns",
        ...
        private void seedInterviews(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Tell about yourself", "Say why you want the job", "Talk about your skills",
                                                "Ask one question"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Describe your previous jobs", "Explain your responsibilities",
                                                "Share what you learned", "Connect experience to new role"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Understand the STAR method", "Provide specific examples",
                                                "Highlight your contributions", "Connect to the role"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Explain technical concepts clearly", "Walk through problem-solving approach",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Articulate leadership philosophy", "Demonstrate strategic thinking",
                                                "Discuss transformation experience", "Show cultural and EQ awareness"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Demonstrate governance sophistication",
