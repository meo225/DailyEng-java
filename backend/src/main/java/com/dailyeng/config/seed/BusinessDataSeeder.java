...
public class BusinessDataSeeder implements CommandLineRunner {
        ...
        private void seedMarketing(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Name the product", "Say what it does", "Say why it\'s good",
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Suggest post ideas", "Choose the best option", "Decide on the message",
                                                "Plan when to post"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Propose campaign ideas", "Discuss target audience",
                                                "Consider different channels", "Agree on next steps"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Present key findings clearly", "Identify market trends",
                                                "Recommend strategic actions", "Defend your methodology"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Analyze current brand perception", "Define new brand positioning",
                                                "Outline implementation roadmap", "Address stakeholder concerns"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Balance global consistency with local relevance",
        ...
        private void seedSales(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Say hello", "Ask how to help", "Listen to their needs",
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Ask about their needs", "Explain product options", "Make a recommendation",
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Introduce your company", "Explain your services", "Highlight benefits",
                                                "Handle objections"));
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Conduct discovery questions", "Identify pain points",
                                                "Present customized solutions", "Create urgency without pressure"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Navigate multi-stakeholder dynamics", "Justify value proposition",
                                                "Structure creative deal terms", "Close with mutual satisfaction"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Articulate compelling joint vision", "Navigate executive-level concerns",
        ...
        private void seedFinance(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Ask the price", "Understand the amount", "Ask about payment methods",
                                                "Complete payment"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Ask about account types", "Understand fees and benefits",
                                                "Ask about requirements", "Decide on an account"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Present budget needs", "Explain each cost item", "Justify expenses",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Present key financial metrics", "Explain variances to budget",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Present compelling financial projections", "Explain business model economics",
                                                "Address investor concerns", "Negotiate investment terms"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Present realistic financial assessment",
                                                "Negotiate with multiple creditor classes",
                                                "Maintain stakeholder confidence", "Structure viable turnaround plan"));
        ...
        private void seedManagement(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Get your manager\'s attention", "Explain your problem simply",
                                                "Listen to advice", "Say thank you"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Explain completed tasks", "Share current work", "Mention any problems",
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Explain project goals", "Assign tasks fairly", "Set clear deadlines",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Discuss achievements objectively", "Address development areas constructively",
                                                "Set future goals", "Align on career path"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Communicate vision compellingly", "Address emotional resistance",
                                                "Build change advocates", "Maintain operational continuity"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Balance competing stakeholder interests", "Maintain fiduciary integrity",
