...
/**
 * Seeds the database with Interview Practice speaking scenarios on first
 * startup.
 * Idempotent — skips if the "interview practice" TopicGroup already exists.
 * Disabled in test profile — test DB does not have schema from Flyway
 * migrations.
 */
@Slf4j
@Component
...
public class InterviewDataSeeder implements CommandLineRunner {
        ...
        private void seedSelfIntroduction(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Share your name and current job", "Mention one reason for applying",
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Structure your introduction logically", "Mention education and work history",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Reference specific company values or projects",
                                                "Connect your experience to their mission", "Show genuine enthusiasm"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Deliver a concise yet impactful pitch", "Highlight leadership achievements",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Show genuine self-awareness", "Describe specific growth actions",
                                                "Demonstrate mature professional reflection"));
        }
        ...
        private void seedBehavioral(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Describe a simple teamwork experience", "Use past tense verbs",
                                                "Say if it was good or bad"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Describe the problem clearly", "Explain what actions you took",
                                                "Share the result"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Use the STAR method structure", "Be specific about your actions",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Show empathy and active listening", "Describe a constructive resolution",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Show accountability without deflecting blame",
                                                "Describe specific lessons learned",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Illustrate strategic stakeholder mapping",
                                                "Demonstrate coalition-building skills",
                                                "Show sophisticated communication and persuasion"));
        }
        ...
        private void seedTechnical(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Name 2-3 tools you use", "Describe what you do with each one",
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("List 2-3 relevant skills", "Give a brief example for each",
                                                "Use past tense for examples"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Explain the project goal clearly", "Describe your specific contribution",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Demonstrate systematic debugging approach",
                                                "Show calm prioritization under pressure",
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Identify key architectural constraints",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Present a compelling technical argument",
                                                "Address counterarguments proactively",
                                                "Demonstrate strategic thinking beyond pure technology"));
        }
        ...
        private void seedSalaryNegotiation(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Understand basic salary vocabulary", "Answer yes/no questions about pay",
                                                "Use numbers to talk about hours"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("State a salary range using numbers", "Ask about one or two benefits",
                                                "Use polite expressions like 'I would like'"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Provide a researched salary range", "Mention factors that justify your range",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Express gratitude before negotiating", "Present data-backed counter-proposal",
                                                "Discuss total compensation, not just salary"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Prioritize negotiation points strategically",
                                                "Negotiate multiple components simultaneously",
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Demonstrate understanding of equity structures",
                                                "Discuss performance-linked incentives",
                                                "Navigate tax and vesting implications with fluency"));
        }
        ...
        private void seedCaseSituational(String groupId, String category) {
                ...
                save(groupId, category, sub, Level.A1,
                                ...
                                List.of("Understand the situation described", "Give a simple answer",
                                                "Use 'I would...' sentences"));
                ...
                save(groupId, category, sub, Level.A2,
                                ...
                                List.of("Show empathy with polite phrases", "Offer a clear solution",
                                                "Use conditional tense for suggestions"));
                ...
                save(groupId, category, sub, Level.B1,
                                ...
                                List.of("Explain your prioritization criteria", "Show communication about trade-offs",
                ...
                save(groupId, category, sub, Level.B2,
                                ...
                                List.of("Consider multiple stakeholders' perspectives",
                                                "Propose a thoughtful course of action",
                                                "Balance ethical principles with practical concerns"));
                ...
                save(groupId, category, sub, Level.C1,
                                ...
                                List.of("Demonstrate structured crisis response", "Balance speed with thoroughness",
                                                "Address multiple stakeholder groups simultaneously"));
                ...
                save(groupId, category, sub, Level.C2,
                                ...
                                List.of("Analyze multiple strategic options rigorously",
                                                "Present a defensible recommendation with evidence",
                                                "Address risks and mitigation strategies for your chosen path"));
        }
