...
INSERT INTO "VocabItem" ("id", "topicId", "word", "pronunciation", "meaning", "translation", "partOfSpeech", "exampleSentence", "exampleTranslation", "synonyms", "collocations") VALUES
('ja-greet-konnichiwa', 'ja-greetings-a1', E'こんにちは (Konnichiwa)', E'/koɴ.ni.tɕi.wa/', E'Hello / Good afternoon', E'Xin chào (buổi chiều)', 'phrase', E'こんにちは、お元気ですか？', E'Hello, how are you?', '{}', ARRAY['daytime greeting']::text[]),
('ja-greet-ohayou', 'ja-greetings-a1', E'おはようございます (Ohayou gozaimasu)', E'/o.ha.joː.ɡo.za.i.ma.sɯ/', E'Good morning (polite)', E'Chào buổi sáng (lịch sự)', 'phrase', E'おはようございます、先生。', E'Good morning, teacher.', '{}', ARRAY['morning greeting']::text[]),
('ja-greet-konbanwa', 'ja-greetings-a1', E'こんばんは (Konbanwa)', E'/koɴ.baɴ.wa/', E'Good evening', E'Xin chào buổi tối', 'phrase', E'こんばんは、今日はどうでしたか？', E'Good evening, how was your day?', '{}', ARRAY['evening greeting']::text[]),
('ja-greet-arigatou', 'ja-greetings-a1', E'ありがとうございます (Arigatou gozaimasu)', E'/a.ɾi.ɡa.toː.ɡo.za.i.ma.sɯ/', E'Thank you very much (polite)', E'Cám ơn rất nhiều (lịch sự)', 'phrase', E'プレゼントをありがとうございます。', E'Thank you very much for the present.', '{}', ARRAY['polite thanks']::text[]),
('ja-greet-sumimasen', 'ja-greetings-a1', E'すみません (Sumimasen)', E'/sɯ.mi.ma.seɴ/', E'Excuse me / I''m sorry', E'Xin lỗi / Xin phép', 'phrase', E'すみません、駅はどこですか？', E'Excuse me, where is the station?', '{}', ARRAY['apology','getting attention']::text[]),
('ja-greet-sayounara', 'ja-greetings-a1', E'さようなら (Sayounara)', E'/sa.joː.na.ɾa/', E'Goodbye (formal)', E'Tạm biệt (trang trọng)', 'phrase', E'さようなら、また明日。', E'Goodbye, see you tomorrow.', '{}', ARRAY['formal farewell']::text[]),
('ja-greet-hajimemashite', 'ja-greetings-a1', E'はじめまして (Hajimemashite)', E'/ha.dʑi.me.ma.ɕi.te/', E'Nice to meet you (first time)', E'Hân hạnh được gặp (lần đầu)', 'phrase', E'はじめまして、田中です。', E'Nice to meet you, I am Tanaka.', '{}', ARRAY['first meeting']::text[]),
('ja-greet-onegaishimasu', 'ja-greetings-a1', E'お願いします (Onegaishimasu)', E'/o.ne.ɡa.i.ɕi.ma.sɯ/', E'Please (polite request)', E'Xin vui lòng / Làm ơn', 'phrase', E'水をお願いします。', E'Water, please.', '{}', ARRAY['polite request']::text[]),
('ja-greet-gomen', 'ja-greetings-a1', E'ごめんなさい (Gomen nasai)', E'/ɡo.meɴ.na.sa.i/', E'I''m sorry (apology)', E'Xin lỗi (xin tha thứ)', 'phrase', E'遅くなってごめんなさい。', E'I''m sorry for being late.', '{}', ARRAY['apology']::text[]),
('ja-greet-ittekimasu', 'ja-greetings-a1', E'行ってきます (Ittekimasu)', E'/it.te.ki.ma.sɯ/', E'I''m leaving (said when going out)', E'Tôi đi đây (nói khi ra khỏi nhà)', 'phrase', E'行ってきます！', E'I''m heading out!', '{}', ARRAY['leaving home']::text[])
ON CONFLICT ("id") DO NOTHING;
...
INSERT INTO "VocabItem" ("id", "topicId", "word", "pronunciation", "meaning", "translation", "partOfSpeech", "exampleSentence", "exampleTranslation", "synonyms", "collocations") VALUES
('ja-num-ichi', 'ja-numbers-a1', E'一 (Ichi)', E'/i.tɕi/', E'One', E'Một', 'noun', E'一つください。', E'One, please.', '{}', ARRAY['counting']::text[]),
('ja-num-ni', 'ja-numbers-a1', E'二 (Ni)', E'/ni/', E'Two', E'Hai', 'noun', E'二人います。', E'There are two people.', '{}', ARRAY['counting']::text[]),
('ja-num-san', 'ja-numbers-a1', E'三 (San)', E'/saɴ/', E'Three', E'Ba', 'noun', E'三時に会いましょう。', E'Let''s meet at three o''clock.', '{}', ARRAY['counting','time']::text[]),
('ja-num-yon', 'ja-numbers-a1', E'四 (Yon/Shi)', E'/joɴ/', E'Four', E'Bốn', 'noun', E'四月は春です。', E'April is spring.', '{}', ARRAY['counting','months']::text[]),
('ja-num-go', 'ja-numbers-a1', E'五 (Go)', E'/ɡo/', E'Five', E'Năm', 'noun', E'五分待ってください。', E'Please wait five minutes.', '{}', ARRAY['counting','time']::text[]),
('ja-num-roku', 'ja-numbers-a1', E'六 (Roku)', E'/ɾo.kɯ/', E'Six', E'Sáu', 'noun', E'六時に起きます。', E'I wake up at six o''clock.', '{}', ARRAY['counting','time']::text[]),
('ja-num-nana', 'ja-numbers-a1', E'七 (Nana/Shichi)', E'/na.na/', E'Seven', E'Bảy', 'noun', E'七月は暑いです。', E'July is hot.', '{}', ARRAY['counting','months']::text[]),
('ja-num-hachi', 'ja-numbers-a1', E'八 (Hachi)', E'/ha.tɕi/', E'Eight', E'Tám', 'noun', E'八百円です。', E'It''s 800 yen.', '{}', ARRAY['counting','price']::text[]),
('ja-num-kyuu', 'ja-numbers-a1', E'九 (Kyuu/Ku)', E'/kjɯː/', E'Nine', E'Chín', 'noun', E'九月に日本へ行きます。', E'I''m going to Japan in September.', '{}', ARRAY['counting','months']::text[]),
('ja-num-juu', 'ja-numbers-a1', E'十 (Juu)', E'/dʑɯː/', E'Ten', E'Mười', 'noun', E'十個あります。', E'There are ten.', '{}', ARRAY['counting']::text[])
ON CONFLICT ("id") DO NOTHING;
...
INSERT INTO "VocabItem" ("id", "topicId", "word", "pronunciation", "meaning", "translation", "partOfSpeech", "exampleSentence", "exampleTranslation", "synonyms", "collocations") VALUES
('ja-daily-hai', 'ja-daily-phrases-a1', E'はい (Hai)', E'/ha.i/', E'Yes', E'Vâng / Dạ', 'phrase', E'はい、そうです。', E'Yes, that''s right.', '{}', ARRAY['affirmation']::text[]),
('ja-daily-iie', 'ja-daily-phrases-a1', E'いいえ (Iie)', E'/iː.e/', E'No', E'Không', 'phrase', E'いいえ、違います。', E'No, that''s not right.', '{}', ARRAY['negation']::text[]),
('ja-daily-daijobu', 'ja-daily-phrases-a1', E'大丈夫 (Daijoubu)', E'/da.i.dʑoː.bɯ/', E'It''s OK / I''m fine', E'Không sao / Ổn mà', 'phrase', E'大丈夫ですか？', E'Are you OK?', '{}', ARRAY['reassurance']::text[]),
('ja-daily-wakarimasen', 'ja-daily-phrases-a1', E'わかりません (Wakarimasen)', E'/wa.ka.ɾi.ma.seɴ/', E'I don''t understand', E'Tôi không hiểu', 'phrase', E'すみません、わかりません。', E'I''m sorry, I don''t understand.', '{}', ARRAY['comprehension']::text[]),
('ja-daily-ikura', 'ja-daily-phrases-a1', E'いくらですか (Ikura desu ka)', E'/i.kɯ.ɾa.de.sɯ.ka/', E'How much is it?', E'Bao nhiêu tiền?', 'phrase', E'これはいくらですか？', E'How much is this?', '{}', ARRAY['shopping','price']::text[]),
('ja-daily-oishii', 'ja-daily-phrases-a1', E'おいしい (Oishii)', E'/o.i.ɕiː/', E'Delicious', E'Ngon', 'adjective', E'このラーメンはおいしいです。', E'This ramen is delicious.', '{}', ARRAY['food','compliment']::text[]),
('ja-daily-kawaii', 'ja-daily-phrases-a1', E'かわいい (Kawaii)', E'/ka.wa.iː/', E'Cute', E'Dễ thương', 'adjective', E'この猫はかわいいです。', E'This cat is cute.', '{}', ARRAY['compliment']::text[]),
('ja-daily-sugoi', 'ja-daily-phrases-a1', E'すごい (Sugoi)', E'/sɯ.ɡo.i/', E'Amazing / Wow', E'Tuyệt vời / Wow', 'adjective', E'すごい！上手ですね。', E'Amazing! You''re good at it.', '{}', ARRAY['exclamation']::text[]),
('ja-daily-tabemasu', 'ja-daily-phrases-a1', E'食べます (Tabemasu)', E'/ta.be.ma.sɯ/', E'To eat (polite)', E'Ăn (lịch sự)', 'verb', E'昼ごはんを食べます。', E'I eat lunch.', '{}', ARRAY['dining','daily activity']::text[]),
('ja-daily-nomimasu', 'ja-daily-phrases-a1', E'飲みます (Nomimasu)', E'/no.mi.ma.sɯ/', E'To drink (polite)', E'Uống (lịch sự)', 'verb', E'お茶を飲みます。', E'I drink tea.', '{}', ARRAY['dining','daily activity']::text[])
ON CONFLICT ("id") DO NOTHING;
